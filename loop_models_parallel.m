function [coor,errcode] = loop_models_parallel(sequence, anchorN, anchorC, anchorNp, anchorCn, prot_coor, constraint, Ramachandran, residue_defs)
...
clash_threshold_lp = 2.8; % (was 2.5) minimum distance between loop and protein residues (except terminal residues)
% constraint_threshold = 10; % maximum Cys 11 CA atom distance from a constraint point
constraint_threshold = 5; % (was 6) maximum Cys 11 projected NO distance from a constraint point
...
NO = NO_std*Rp + CAcoor;
pair_dist = get_all_pair_dist(NO,constraint);
