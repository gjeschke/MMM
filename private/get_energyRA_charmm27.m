function out = get_energyRA_charmm27(coor1,coor2,run_opt)

% out = get_energyRA_charmm27(coor1,coor2,run_opt)
...
q2=q.^2;
q6 = q2.*q2.*q2;
d=exp(log(repulsion)-log(6));
Energy = eps.*(q.^repulsion-d*q6);
