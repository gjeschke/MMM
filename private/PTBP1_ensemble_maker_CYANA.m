function PTBP1_ensemble_maker_CYANA
...
fprintf(fid,'color [PTB1](B){:} grey\n');
fprintf(fid,'color [PTB1](A){:}58-154 crimson\n');
fprintf(fid,'color [PTB1](A){:}155-181 goldenrod\n');
fprintf(fid,'color [PTB1](A){:}182-283 darkgreen\n');
fprintf(fid,'color [PTB1](A){:}284-336 slateblue\n');
fprintf(fid,'color [PTB1](A){:}337-531 darkblue\n');
