function out = get_energy_avgLJ(coor1,coor2,run_opt)

% out = get_energy_avgLJ(coor1,coor2,run_opt)
...
Rmin = repmat(Rmin2_i0(:),1,m2) + repmat(Rmin2_j0,m1,1);
Energy = eps.*polyval(run_opt.p,pair_dist./Rmin,[],run_opt.mu);

            % ATTENTION! Rmin2_i0 - is actually Rmin_i0/2
