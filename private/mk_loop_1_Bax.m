function [coor,A,acoor,errcode,clashes,nofit] = mk_loop_1_Bax(sequence, anchorN, anchorNp, prot_coor, loc126)
...
while failed && attempts < maxattempts,
    ...
    if clash,
        ...
        pair_dist = get_all_pair_dist(backbone(9:21,:),prot_coor);
