function out = get_energy_clash(coor1,coor2,run_opt)

% out = get_energy_repulsion(coor1,coor2,run_opt)
...
%--------------------------------------------------------------------------
used_potential='pure repulsion';    % potential type used
%--------------------------------------------------------------------------
...
Energy=zeros(size(Rmin));
Energy(pair_dist<Rmin)=1e6;
