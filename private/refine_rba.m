...
if ~isempty(combination)
    ...
    [v1,cost] = fminsearch(@rba_cost_fct,v0,options,atransmat,rb,points,naux,auxiliary,ncore,core,links,clash_threshold,heavy_coor,stemlibs,combination,sl_atoms,pthr,clash_fail);
end
telapsed = toc(tstart);
