function obj=capped_tube(p1,p2,color,radius,alpha)
% function obj=capped_tube(p1,p2,color,radius,alpha)
%
% Plots a capped tube for point p1 to point p2
%
...
[x,y,z,t]=point2trisphere(p2,radius);
obj2=trisurf(t,x,y,z);
...
[x,y,z] = vec2tube(p1,p2,radius,10);
obj3=surface(x,y,z);
set(obj3, 'FaceColor', color, 'EdgeColor', 'none', 'FaceAlpha',alpha,'FaceLighting','gouraud','Clipping','off');
