function display_multilateration_Bax_1
...
save Bax_H6_ext_H5_detergent_models descr all_h6coor all_loopcoor
...
for k=1:length(restraints.locate),
    ...
    if strcmpi(adr1,'126') && exist('loc126','var'),
        ...
        if strcmpi(adr1,'126'),
            fprintf(1,'Residue 126 label coordinates: (%5.2f, %5.2f, %5.2f) Å',info(k).xyz);
        end;
        if ~f1,
